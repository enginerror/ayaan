    ...
    <div className="min-h-screen overflow-hidden">
      <div className="m-5 mb-0">
        ...
        <div className="flex flex-col gap-10">
          <TextRevel>
            <h1 className="mt-18 text-[36px] leading-[1.3] tracking-tight">
              Hey Alex, my name is{" "}
              <span className="text-[#FF2F00]">[your first name]</span>. I would
              like to start a new project with you. I’m looking for{" "}
              <span className="text-[#FF2F00]">[type a service]</span>. The
              timing for this project is{" "}
              <span className="text-[#FF2F00]">[timeframe]</span>. The budget is{" "}
              <span className="text-[#FF2F00]">[your budget]</span>. You can
