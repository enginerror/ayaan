...
const Footer = () => {
  return (
    <div className="w-full mt-6 sm:mt-8 md:mt-12 p-6 bg-muted-border border border-muted-border flex justify-between items-center">
      <div className="flex flex-col lg:flex-row lg:items-center">
        <Link to="/" className="text-lg sm:text-xl md:text-2xl prata-regular mr-2 lg:mr-4">
          enginerror
        </Link>{" "}
        <span className="hidden sm:block">|</span> <p className="lg:ml-4 text-muted-foreground text-xs lg:text-lg">copyright &#169;</p>
      </div>
