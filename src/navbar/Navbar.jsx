...
const Navbar = () => {
  ...
  return (
    <>
      ...
      {/* Mobile Menu */}
      <div
        className={`sm:hidden fixed inset-0 bg-background z-50 transition-transform duration-300 ease-in-out ${
      ...
      >
        ...
        <div className="flex flex-col justify-center h-[calc(100vh-80px)]">
          <Link to="/" onClick={() => setOpen(false)}>
            <div className="text-center text-lg sm:text-xl uppercase border-t border-gray-300 py-2.5 hover:bg-black hover:text-white transition-all duration-200">
              Home
            </div>
          </Link>
          ...
          <Link to="/courses" onClick={() => setOpen(false)}>
            <div className="text-center text-lg sm:text-xl uppercase border-t border-b border-gray-300 py-2.5 hover:bg-black hover:text-white transition-all duration-200">
              Courses
            </div>
          </Link>
        </div>
