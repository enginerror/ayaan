    ...
    <div className="h-[90vh] w-full flex flex-col items-center justify-center px-4 py-8 sm:px-6 md:px-8">
      ...
      <div className="w-full flex justify-center items-center gap-3 sm:gap-4 mt-8 sm:mt-10 flex-wrap sm:flex-nowrap px-4">
        <button
          ...
          className="px-4 sm:px-6 py-2 sm:py-2.5 border-2 border-[#D97757] bg-[#D97757] text-white rounded-2xl text-sm sm:text-base hover:bg-[#d97857ea] hover:border-[#d97857ea] transition-colors w-full sm:w-auto"
        >
          Projects
        </button>
        <button
          onClick={() => window.open("/Ayaan_Resume.pdf", "_blank")}
          className="px-4 sm:px-6 py-2 sm:py-2.5 border-2 border-[#030712] rounded-2xl flex gap-2 items-center justify-center text-sm sm:text-base hover:bg-gray-100 transition-colors w-full sm:w-auto"
        >
          Resume{" "}
          <FileText
