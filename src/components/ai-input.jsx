...
function DockBar() {
  ...
  return (
    <footer className="mt-auto flex h-11 items-center justify-center select-none">
      <div className="flex items-center justify-center gap-2 px-3 max-sm:h-10 max-sm:px-2">
        <div onClick={triggerOpen} className="flex w-fit items-center gap-2">
        ...
        {showForm && (
          ...
          >
            <div className="flex justify-between py-1">
              <p className="text-foreground z-2 ml-[38px] flex items-center gap-1.5 select-none">
                AI Input
              </p>
              <button
                type="submit"
